...
var _viewSpecimen = __webpack_require__(36);

var _viewSpecimen2 = _interopRequireDefault(_viewSpecimen);

var _parseColumnArray = __webpack_require__(18);

var _parseColumnArray2 = _interopRequireDefault(_parseColumnArray);

var _errorBoundary = __webpack_require__(19);
...
var basicList = function (_React$Component) {
    _inherits(basicList, _React$Component);

    function basicList(props) {
        _classCallCheck(this, basicList);

        var _this = _possibleConstructorReturn(this, (basicList.__proto__ || Object.getPrototypeOf(basicList)).call(this, props));
        ...
        if (props.hasOwnProperty("records")) {
            _this.state.records = props.records;
        }
        if (props.hasOwnProperty("columns")) {
            if (Array.isArray(props.columns)) {
                _this.state.columns = props.columns.reduce(function (a, c) {
    ...
    _createClass(basicList, [{
        ...
        key: "exportToCSVButtonClicked",
        value: function exportToCSVButtonClicked(e) {}
    }, {
        key: "openRecordButtonClicked",
        value: function openRecordButtonClicked() {}
    }, {
        key: "renderFooter",
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    { className: "btn btn-primary", type: "button", onClick: function onClick(e) {
                            return _this2.exportToCSVButtonClicked(e);
                        } },
                    "Export CSV"
                )
            );
        ...
        value: function renderTableHeaderRow() {
            ...
            return _react2.default.createElement(
                "tr",
                null,
                Object.keys(this.state.columns).map(function (c, idx) {
                    return _react2.default.createElement(
                        "th",
                        { key: idx, scope: "col" },
                        _this3.state.columns[c].title
                    );
                })
            );
        }
    }, {
        key: "renderTableBodyRows",
        value: function renderTableBodyRows() {
            var _this4 = this;

            return this.state.records.map(function (r) {
                return _this4.renderTableBodyRow(r);
            });
        }
    }, {
        key: "renderTableBodyRow",
        value: function renderTableBodyRow(record) {
            var _this5 = this;

            return _react2.default.createElement(
                "tr",
                { key: record.id },
                Object.keys(this.state.columns).map(function (c_key, idx) {
                    var contents = record[c_key];
                    if (_this5.state.columns[c_key].type == "String") {
                        contents = record[c_key];
                    }
                    if (_this5.state.columns[c_key].type == "Date") {
                        contents = record[c_key].toLocaleString();
                    }
                    if (_this5.state.columns[c_key].type == "Number") {
                        contents = parseInt(record[c_key], 10);
                    }
                    if (_this5.state.columns[c_key].type == "Link") {
                        contents = record[c_key]; //soon...
                    }
                    return _react2.default.createElement(
                        "td",
                        { key: idx },
                        idx ? contents : _react2.default.createElement(
                            "a",
                            { href: "#", onClick: function onClick(e) {
                                    return _this5.openTab(record[c_key], _react2.default.createElement(_viewSpecimen2.default, { specimen: record }), true);
                                } },
                            contents
                        )
                    );
...
var SpeciesSelectBox = function (_React$Component) {
    _inherits(SpeciesSelectBox, _React$Component);

    function SpeciesSelectBox(props) {
        _classCallCheck(this, SpeciesSelectBox);

        var _this = _possibleConstructorReturn(this, (SpeciesSelectBox.__proto__ || Object.getPrototypeOf(SpeciesSelectBox)).call(this, props));
        ...
        value: function loadedSpeciesList(data) {
            this.setState({
                species: data.map(function (s) {
                    return _react2.default.createElement(
                        'option',
                        { className: 'speciesSelectionBox', key: s.id, value: s.id },
                        s.genus.toUpperCase().slice(0, 1),
                        '. ',
                        s.species
                    );
                })
    ...
    return SpeciesSelectBox;
}(_react2.default.Component);

exports.default = SpeciesSelectBox;
...
var ObservationForm = function (_React$Component) {
    _inherits(ObservationForm, _React$Component);

    function ObservationForm(props) {
        _classCallCheck(this, ObservationForm);

        var _this = _possibleConstructorReturn(this, (ObservationForm.__proto__ || Object.getPrototypeOf(ObservationForm)).call(this, props));
...
exports.default = parseColumnArray;
...
var _specimenBox = __webpack_require__(32);
...
var _observationList = __webpack_require__(33);
...
window.createSpecimen = function () {
    _reactDom2.default.render(_react2.default.createElement(_speciesSelect2.default, null), document.getElementById('speciesSelectBox'));
};
...
window.mountApp = function (element_id) {
    _reactDom2.default.render(_react2.default.createElement(_app2.default, null), document.getElementById(element_id));
};
...
var _listAllSpecimens = __webpack_require__(35);

var _listAllSpecimens2 = _interopRequireDefault(_listAllSpecimens);

var _createSpecimen = __webpack_require__(37);

var _createSpecimen2 = _interopRequireDefault(_createSpecimen);

var _queryList = __webpack_require__(38);

var _queryList2 = _interopRequireDefault(_queryList);

var _basicList2 = __webpack_require__(8);
...
var BaseList = function (_basicList) {
    _inherits(BaseList, _basicList);

    function BaseList() {
        _classCallCheck(this, BaseList);

        return _possibleConstructorReturn(this, (BaseList.__proto__ || Object.getPrototypeOf(BaseList)).apply(this, arguments));
    }
...
var App = function (_React$Component) {
    ...
    function App(props) {
        ...
        _this2.state = { tabs: [], current_tab: 0, collections: [] };
        return _this2;
    }
    ...
    _createClass(App, [{
        ...
        value: function componentDidMount() {
            ...
            fetch("/specimen/all", {
                ...
                _this3.setState({ collections: data });
                _this3.openBaseListTab();
            });
        }
    }, {
        key: "switchTab",
        value: function switchTab(toTab, eventObj) {
        ...
        key: "openTab",
        value: function openTab(tab_name, tab_src, switch_on_open) {
            var tab_idx = this.state.tabs.push({ title: tab_name, src: tab_src }) - 1;
        ...
        value: function openBaseListTab(columns, records) {
            ...
            this.openTab("List", _react2.default.createElement(BaseList, { columns: c, records: r, openTab: this.openTab.bind(this) }), true);
        }
    }, {
        key: "deleteTab",
        value: function deleteTab(tab_idx) {
            var update_state = {
                tabs: this.state.tabs,
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    "div",
                    { className: "collapse", id: "mahhamburger" },
                    _react2.default.createElement(
                        "div",
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                ...
                                _react2.default.createElement(
                                    "a",
                                    { href: "#", onClick: function onClick(e) {
                                            e.preventDefault();_this4.openBaseListTab();
                                        } },
                                    "List all"
                                )
                            ),
                            _react2.default.createElement(
                                ...
                                _react2.default.createElement(
                                    "a",
                                    { href: "#", "data-toggle": "collapse", "data-target": "#queryDiv" },
                                    "Query"
                                ),
                                _react2.default.createElement(
                                    "div",
                                    { className: "collapse", id: "queryDiv" },
                                    _react2.default.createElement(_queryList2.default, { openTab: this.openTab.bind(this) })
                                )
                            ),
                            _react2.default.createElement(
                                "li",
                ...
                _react2.default.createElement(
                    "ul",
                    { className: "nav nav-pills nav-justified bg-secondary" },
                    this.state.tabs.map(function (t, idx) {
                        return _react2.default.createElement(
                            "li",
                            { className: "nav-item", key: idx },
                            _react2.default.createElement(
                                "a",
                                { className: idx == _this4.state.current_tab && "nav-link active" || "nav-link", href: "#", onClick: function onClick(e) {
                                        e.preventDefault();
                                        _this4.switchTab(idx, e);
                                    } },
                                t.title,
                                _react2.default.createElement(
                                    "button",
                ...
                _react2.default.createElement(
                    ...
                    this.state.tabs.length ? this.state.tabs.map(function (t, i) {
                        var inner = t.src;
                        if (i == _this4.state.current_tab) {
                            return _react2.default.createElement(
                                "div",
                                { key: i },
                                t.src
...
var ListAllSpecimens = function (_basicList) {
    ...
    function ListAllSpecimens(props) {
        _classCallCheck(this, ListAllSpecimens);

        //this.state.columns = {columns: ["id","species", "genus", "quantity","size","source","location","planter"]}));
        var _this = _possibleConstructorReturn(this, (ListAllSpecimens.__proto__ || Object.getPrototypeOf(ListAllSpecimens)).call(this, props));
...
var ViewSpecimen = function (_React$Component) {
    _inherits(ViewSpecimen, _React$Component);

    function ViewSpecimen(props) {
        _classCallCheck(this, ViewSpecimen);

        var _this = _possibleConstructorReturn(this, (ViewSpecimen.__proto__ || Object.getPrototypeOf(ViewSpecimen)).call(this, props));

        _this.state = {};
        if (Number.isInteger(props.specimen)) {
            _this.state.specimen = {
                id: props.specimen
            };
        } else {
            _this.state.specimen = props.specimen;
        }
        _this.state.comments = [];
        return _this;
    }

    _createClass(ViewSpecimen, [{
        key: "componentDidMount",
        value: function componentDidMount() {
            this.loadComments();
        }
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    "div",
                    { className: "card-header text-white bg-" + colorFor(this.state.comments.length ? this.state.comments[0].status : null) },
                    _react2.default.createElement(
                        "h1",
                        null,
                        _react2.default.createElement(
                            "i",
                            null,
                            this.state.specimen.genus,
                            " ",
                            this.state.specimen.species
                        ),
                        " (ID: ",
                        this.state.specimen.id,
                        ")"
                    )
                ),
                _react2.default.createElement(
...
var createSpecimen = function createSpecimen() {
    _reactDom2.default.render(_react2.default.createElement(_speciesSelect2.default, null), document.getElementById('speciesSelectBox'));
};

var CreateNewSpecimen = function (_React$Component) {
    _inherits(CreateNewSpecimen, _React$Component);

    function CreateNewSpecimen(props) {
        _classCallCheck(this, CreateNewSpecimen);

        return _possibleConstructorReturn(this, (CreateNewSpecimen.__proto__ || Object.getPrototypeOf(CreateNewSpecimen)).call(this, props));
    }

    _createClass(CreateNewSpecimen, [{
        key: "render",
        value: function render() {
            return _react2.default.createElement(
                "form",
                ...
                _react2.default.createElement("input", { className: "form-control", type: "number", name: "quantity" }),
                _react2.default.createElement("input", { className: "form-control", type: "text", name: "size" }),
                _react2.default.createElement("input", { className: "form-control", type: "text", name: "planter" }),
                _react2.default.createElement("input", { className: "form-control", type: "text", name: "source" }),
                _react2.default.createElement("input", { className: "form-control", type: "text", name: "location" }),
                _react2.default.createElement(
                    "button",
    ...
    return CreateNewSpecimen;
}(_react2.default.Component);

exports.default = CreateNewSpecimen;
...
var _basicList = __webpack_require__(8);
...
var QueryList = function (_React$Component) {
    ...
    function QueryList(props) {
        ...
        var _this = _possibleConstructorReturn(this, (QueryList.__proto__ || Object.getPrototypeOf(QueryList)).call(this, props));

        _this.state = { query: "" };
        _this.openTab = props.openTab;
        _this.parseColumnArray = _parseColumnArray2.default;
        return _this;
    }
    ...
    _createClass(QueryList, [{
            ...
            if (this.state.query) {
                return fetch("/query/", {
                    ...
                    data.json().then(function (d) {
                        if (d.length) {
                            var c = _this2.parseColumnArray(Object.keys(d[0]));
                            _this2.openTab("" + _this2.state.query, _react2.default.createElement(_basicList2.default, { records: d, columns: c, openTab: _this2.openTab.bind(_this2) }), true);
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                "form",
                null,
                _react2.default.createElement("textarea", { className: "form-control", value: this.state.query, onChange: function onChange(e) {
                        return _this3.updateQuery(e);
                    } }),
                _react2.default.createElement(
                    "button",
                    { className: "button", type: "button", onClick: function onClick(e) {
                            return _this3.runQuery(e);
                        } },
                    "Run"
                )
            );
